...
public class Win extends ObjetoJuego {
	
	private int cantidadVidas;
	private boolean capturado = false;
	

	public Win (int x, int y, String nombreImagen, int velocidad, int cantidadVidas) {
	...
	public void pintar(GraphicsContext graficos) {
		...
		graficos.drawImage(Juego.imagenes.get("ganar"), this.x, this.y);
