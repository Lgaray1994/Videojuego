...
public class Enemigos2 extends ObjetoJuego {
	...
	private HashMap<String, Animacion>animaciones;//arraylist de indices textos en vez de numeros
		...
		public Enemigos2  (int x, int y, String nombreImagen, int velocidad, int cantidadVidas,String animacionActual) {
		...
		public void inicializarAnimaciones() 
		{
			...
			{
			new Rectangle(326,1,71,76),
			new Rectangle(325,98,63,81),
			new Rectangle(334,201,50,90),
			...
			Rectangle coordenadasCorrerA[] = 
				{
						...
						new Rectangle(0,0,58,76),
						new Rectangle(0,100,53,79),
						new Rectangle(0,201,62,86),
				...
				Rectangle coordenadasCorrerArriba[] = 
					...
					new Rectangle(232,0,54,73),
					new Rectangle(219,99,61,77),
					new Rectangle(226,203,64,84),
		...
		public void pintar(GraphicsContext graficos) 
		{
			...
			graficos.drawImage(Juego.imagenes.get("enemigo2"),xImagen,yImagen,anchoImagen,altoImagen,x+ (direccion== -1?anchoImagen:0) ,y,direccion*anchoImagen,altoImagen);//xImage,Yimage,anchoFragmento,altoFragmento,Xpintar,Y pintar,anchoPintar,altoPintar
