...
public class ParedesAnimadas  extends ObjetoJuego {
	private int vidas;
	private HashMap<String, Animacion>animaciones;//arraylist de indices textos en vez de numeros
		...
		public ParedesAnimadas(int x, int y, String nombreImagen, int velocidad, int vidas,String animacionActual) {
		...
		public void inicializarAnimaciones() 
		{
			...
			Rectangle coordenadasDescanso[] = 
				{
				new Rectangle(0,1,65,499),
				new Rectangle(95,0,61,500),
				
				
				};
			Animacion animacionDescanso = new Animacion (0.38,coordenadasDescanso);
			animaciones.put("Gif",animacionDescanso);
		}
		...
		public void pintar(GraphicsContext graficos) 
		{
			...
			graficos.drawImage(Juego.imagenes.get("fuego"),xImagen,yImagen,anchoImagen,altoImagen,x+ (direccion== -1?anchoImagen:0) ,y,direccion*anchoImagen,altoImagen);//xImage,Yimage,anchoFragmento,altoFragmento,Xpintar,Y pintar,anchoPintar,altoPintar
